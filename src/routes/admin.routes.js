...
// Announcements (Admin can send to any class or everyone)
...
// Calendar (Admin manages; everyone can view via their own role's routes)
router.post("/calendar-events", calendarCtrl.createEvent);
router.delete("/calendar-events/:eventId", calendarCtrl.deleteEvent);
