...
// no-cache on the JS/CSS/HTML specifically: without this, mobile browsers
// tend to hold onto the old copy of these files fairly aggressively, so
// pushing a real update wouldn't reliably reach someone's phone without
// them manually clearing site data first. Uploaded images/PDFs (served
// separately above) are unaffected and still cache normally — those
// never change once uploaded, so long caching there is fine and desired.
